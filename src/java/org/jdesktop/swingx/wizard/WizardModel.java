 ...
 *
 * $Id: WizardModel.java 1019 2015-08-03 19:13:54Z Michael $
 */
...
import org.jdesktop.swingx.wizard.models.MultiPathModel;
import org.jdesktop.swingx.wizard.models.StaticModel;
 ...
 * the basic methods and property change management required by all models.
 */
public interface
WizardModel
{
   ...
   /**
    * Takes the model back to the previous step and fires the appropriate property change events.
...
//   /**
//    * Returns an iterator over all the steps in the model.  The iteration order is not guaranteed
//    * to the be the order of traversal.
//    * @return an iterator over all the steps of the model
//    * @deprecated Use {@link #getSteps()}
//    */
//   @Deprecated
//   Iterator<WizardStep>
//   stepIterator();
    ...
    * Returns an iterator over all the steps in the model.  The iteration order is not guaranteed
    * to the be the order of traversal.
    * @return a list of all the steps of the model
    */
   List<WizardStep>
   getSteps();
