 ...
 *
 * $Id: DynamicModel.java 1019 2015-08-03 19:13:54Z Michael $
 */
...
extends AbstractWizardModel
{
    ...
    * calling {@link #add(org.jdesktop.swingx.wizard.WizardStep, Condition) add(step, TRUE_CONDITION)}.
    * <p>
    ...
    * condition is met.
    *
    * @param step      the {@link org.jdesktop.swingx.wizard.WizardStep} to add.
...
public boolean
    ...
    * conditional steps by calling {@link Condition#evaluate(org.jdesktop.swingx.wizard.WizardModel)}.
    * <p>
