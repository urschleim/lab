 ...
 *
 * $Id: Wizard.java 1019 2015-08-03 19:13:54Z Michael $
 */
 ...
 * <p>
 * In the simplest case, you would subclass {@link org.jdesktop.swingx.wizard.models.StaticModel} and add a number
 ...
 * </pre>
 *
 * @see org.jdesktop.swingx.wizard.models.StaticModel
 * @see org.jdesktop.swingx.wizard.models.DynamicModel
 * @see org.jdesktop.swingx.wizard.models.MultiPathModel
 */
public class
Wizard
extends JPanel
{
    ...
    public Wizard(WizardModel model)
    {
        ...
        for ( WizardStep c : model.getSteps() )
        {
            c.init(this.model);
        }
    ...
    /**
     * Calculates the preferred size of the main wizard area based on the {@link WizardStep#getPreferredSize}
    ...
    /**
     * Generated for Wizard.java.
     */
    private static final long serialVersionUID = -8396324586932520737L;
}
