...
abstract public class ConsoleApplication
{
    private static final Logger LOG =
            Logger.getLogger( ConsoleApplication.class.getName() );
    ...
    static
    {
        ...
        addConverter(
                Integer.TYPE,
                ConsoleApplication::stringToInt );
        addConverter(
                Long.TYPE,
                ConsoleApplication::stringToLong );
        addConverter(
                File.class,
                ConsoleApplication::stringToFile );
        addConverter(
                Boolean.TYPE,
                ConsoleApplication::stringToBoolean );
    }
    ...
    private static final void launchImpl(
            Class<? extends ConsoleApplication> cl,
            String[] argv )
        throws Exception
    {
        ConsoleApplication instance = null;
        ...
        try {
            ...
            instance = (ConsoleApplication) c.newInstance();
        }
        catch (Exception e) {
            e.printStackTrace();
     ...
     * terminates.
     */
    static public void launch( Class<? extends ConsoleApplication> cl, String[] argv, boolean explicitExit )
    {
        try
        {
            launchImpl(cl, argv);
     ...
     * @param argv The unmodified parameter array.
     */
    static public void launch( Class<? extends ConsoleApplication> cl, String[] argv )
    {
